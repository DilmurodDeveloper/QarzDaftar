...
namespace QarzDaftar.Server.Api.Services.Foundations.UserNotes
{
    public partial class UserNoteService
    {
        ...
        private void ValidateUserNoteOnModify(UserNote userNote)
        {
            ValidateUserNoteNotNull(userNote);
        ...
        private void ValidateAgainstStorageUserNoteOnModify(UserNote userNote, UserNote storageUserNote)
        {
            ValidateStorageUserNote(storageUserNote, userNote.Id);
